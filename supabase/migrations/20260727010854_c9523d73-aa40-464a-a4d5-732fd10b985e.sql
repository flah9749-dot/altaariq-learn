...
-- Tree overview: classes with aggregate stats
...
-- Tree overview: groups inside a class with aggregate stats
...
-- Tree leaves: students inside a group (paginated, lightweight)
CREATE OR REPLACE FUNCTION public.admin_tree_students_in_group(
  _class_id uuid,
  _group_id uuid,
