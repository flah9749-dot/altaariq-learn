...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.png?v=1", type: "image/png", sizes: "any" },
      { rel: "icon", href: "/favicon-16.png?v=1", type: "image/png", sizes: "16x16" },
      { rel: "icon", href: "/favicon-32.png?v=1", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/favicon-48.png?v=1", type: "image/png", sizes: "48x48" },
      { rel: "icon", href: "/icon-192.png?v=1", type: "image/png", sizes: "192x192" },
      { rel: "icon", href: "/icon-512.png?v=1", type: "image/png", sizes: "512x512" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=1", sizes: "180x180" },
